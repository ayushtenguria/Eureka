          ...
          <div className="w-full md:w-1/2 relative">
            ...
            >
              ...
              <motion.div 
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="absolute bottom-20 left-0 transform -translate-x-1/3"
              >
              ...
              <motion.div 
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="absolute bottom-20 right-0 transform translate-x-1/3"
              >
                <div className="bg-white dark:bg-gray-900 rounded-full px-6 py-3 shadow-lg flex items-center gap-3 border border-blue-100">
...
// Dot pattern component with animation
const DotPattern = () => {
  return (
